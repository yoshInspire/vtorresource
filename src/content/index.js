...
/**
 * Первый экран: адрес и заголовок. Оффер («взвесим при вас и рассчитаемся
 * в тот же день»), лента фактов и форма с него убраны по просьбе заказчика:
 * заявку принимает блок контактов внизу страницы.
 */
const hero = {
