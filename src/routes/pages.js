...
router.get('/radiodetali', (req, res) => {
  ...
  res.render('catalog', {
    ...
    lead:
      ...
      'Сначала идут платы, затем детали по категориям.',
...
router.get('/dragmetally', (req, res) => {
  ...
  res.render('catalog', {
    ...
    about: [
      'Мы принимаем лом, содержащий драгметаллы: контакты, ламели, катализаторы, ' +
      'термопары, узлы приборов. Ювелирные изделия, слитки и монеты не принимаем, ' +
      'это отдельный вид деятельности со своим лицензированием.',
